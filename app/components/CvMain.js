...
const bodyClass = "text-slate-600 text-[15px] print:text-[13px] leading-relaxed print:leading-[1.15]";
  ...
  return (
    <main className="flex-1 p-6 md:p-8 print:p-1 bg-white">
      <section className="mb-8 print:mb-0.5">
        ...
        <p className="text-slate-700 text-[15px] print:text-[13px] leading-relaxed print:leading-[1.15]">
          {profile.body}{" "}
